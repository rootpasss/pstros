...
public class RecordStore
{
	...
	private RecordStore(String recordStoreName, boolean createIfNecessary) throws RecordStoreException, RecordStoreNotFoundException
	{
		...
		name = recordStoreName;
                appname=ole.pstros.MainApp.appName;

		/*rmsPath = "rms/"+appname;
		rmsFile = "rms/"+appname+"/"+recordStoreName;*/
                rmsPath=System.getProperty("user.home")+"/.pstros/";
                rmsFile=rmsPath+"rms_"+appname;
